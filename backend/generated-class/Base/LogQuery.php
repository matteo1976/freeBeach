 ...
 * @method     ChildLogQuery orderByEntita($order = Criteria::ASC) Order by the entita column
 * @method     ChildLogQuery orderByProprieta($order = Criteria::ASC) Order by the proprieta column
 * @method     ChildLogQuery orderByValorePrecedente($order = Criteria::ASC) Order by the valore_precedente column
 * @method     ChildLogQuery orderByValoreNuovo($order = Criteria::ASC) Order by the valore_nuovo column
 *
 * @method     ChildLogQuery groupById() Group by the id column
 * @method     ChildLogQuery groupByData() Group by the data column
 * @method     ChildLogQuery groupByEntita() Group by the entita column
 * @method     ChildLogQuery groupByProprieta() Group by the proprieta column
 * @method     ChildLogQuery groupByValorePrecedente() Group by the valore_precedente column
 * @method     ChildLogQuery groupByValoreNuovo() Group by the valore_nuovo column
 *
 ...
 * @method     ChildLog findOneByEntita(string $entita) Return the first ChildLog filtered by the entita column
 * @method     ChildLog findOneByProprieta(string $proprieta) Return the first ChildLog filtered by the proprieta column
 * @method     ChildLog findOneByValorePrecedente(string $valore_precedente) Return the first ChildLog filtered by the valore_precedente column
 * @method     ChildLog findOneByValoreNuovo(string $valore_nuovo) Return the first ChildLog filtered by the valore_nuovo column *
 ...
 * @method     ChildLog requireOneByEntita(string $entita) Return the first ChildLog filtered by the entita column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildLog requireOneByProprieta(string $proprieta) Return the first ChildLog filtered by the proprieta column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildLog requireOneByValorePrecedente(string $valore_precedente) Return the first ChildLog filtered by the valore_precedente column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildLog requireOneByValoreNuovo(string $valore_nuovo) Return the first ChildLog filtered by the valore_nuovo column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildLog[]|ObjectCollection findByEntita(string $entita) Return ChildLog objects filtered by the entita column
 * @method     ChildLog[]|ObjectCollection findByProprieta(string $proprieta) Return ChildLog objects filtered by the proprieta column
 * @method     ChildLog[]|ObjectCollection findByValorePrecedente(string $valore_precedente) Return ChildLog objects filtered by the valore_precedente column
 * @method     ChildLog[]|ObjectCollection findByValoreNuovo(string $valore_nuovo) Return ChildLog objects filtered by the valore_nuovo column
...
abstract class LogQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'dbspiaggie', $modelName = '\\Log', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, data, entita, proprieta, valore_precedente, valore_nuovo FROM log WHERE id = :p0';
        try {
    ...
    /**
     * Filter the query on the entita column
     *
     * Example usage:
     * <code>
     * $query->filterByEntita('fooValue');   // WHERE entita = 'fooValue'
     * $query->filterByEntita('%fooValue%', Criteria::LIKE); // WHERE entita LIKE '%fooValue%'
     * </code>
     *
     * @param     string $entita The value to use as filter.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this|ChildLogQuery The current query, for fluid interface
     */
    public function filterByEntita($entita = null, $comparison = null)
    {
        if (null === $comparison) {
            if (is_array($entita)) {
                $comparison = Criteria::IN;
        ...
        return $this->addUsingAlias(LogTableMap::COL_ENTITA, $entita, $comparison);
    }

    /**
     * Filter the query on the proprieta column
     *
     * Example usage:
     * <code>
     * $query->filterByProprieta('fooValue');   // WHERE proprieta = 'fooValue'
     * $query->filterByProprieta('%fooValue%', Criteria::LIKE); // WHERE proprieta LIKE '%fooValue%'
     * </code>
     *
     * @param     string $proprieta The value to use as filter.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this|ChildLogQuery The current query, for fluid interface
     */
    public function filterByProprieta($proprieta = null, $comparison = null)
    {
        if (null === $comparison) {
        ...
        return $this->addUsingAlias(LogTableMap::COL_PROPRIETA, $proprieta, $comparison);
    }

    /**
     * Filter the query on the valore_precedente column
     *
     * Example usage:
     * <code>
     * $query->filterByValorePrecedente('fooValue');   // WHERE valore_precedente = 'fooValue'
     * $query->filterByValorePrecedente('%fooValue%', Criteria::LIKE); // WHERE valore_precedente LIKE '%fooValue%'
     * </code>
     *
     * @param     string $valorePrecedente The value to use as filter.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this|ChildLogQuery The current query, for fluid interface
     */
    public function filterByValorePrecedente($valorePrecedente = null, $comparison = null)
    {
        if (null === $comparison) {
            if (is_array($valorePrecedente)) {
                $comparison = Criteria::IN;
            }
        }

        return $this->addUsingAlias(LogTableMap::COL_VALORE_PRECEDENTE, $valorePrecedente, $comparison);
    }

    /**
     * Filter the query on the valore_nuovo column
     *
     * Example usage:
     * <code>
     * $query->filterByValoreNuovo('fooValue');   // WHERE valore_nuovo = 'fooValue'
     * $query->filterByValoreNuovo('%fooValue%', Criteria::LIKE); // WHERE valore_nuovo LIKE '%fooValue%'
     * </code>
     *
     * @param     string $valoreNuovo The value to use as filter.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this|ChildLogQuery The current query, for fluid interface
     */
    public function filterByValoreNuovo($valoreNuovo = null, $comparison = null)
    {
        if (null === $comparison) {
            if (is_array($valoreNuovo)) {
                $comparison = Criteria::IN;
            }
        }

        return $this->addUsingAlias(LogTableMap::COL_VALORE_NUOVO, $valoreNuovo, $comparison);
    }
