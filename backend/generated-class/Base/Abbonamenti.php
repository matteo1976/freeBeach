...
/**
 * Base class that represents a row from the 'abbonamenti' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Abbonamenti implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\AbbonamentiTableMap';
    ...
    /**
     * The value for the codice field.
     *
     * @var        string
     */
    protected $codice;
    ...
    /**
     * Initializes internal state of Base\Abbonamenti object.
     */
    ...
    /**
     * Compares this with another <code>Abbonamenti</code> instance.  If
     * <code>obj</code> is an instance of <code>Abbonamenti</code>, delegates to
     * <code>equals(Abbonamenti)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Abbonamenti The current object, for fluid interface
     */
     ...
     * @return $this|\Abbonamenti The current object (for fluent API support)
     */
    public function setIdAbbonamento($v)
    {
        ...
        if ($this->id_abbonamento !== $v) {
            ...
            $this->modifiedColumns[AbbonamentiTableMap::COL_ID_ABBONAMENTO] = true;
        }
    ...
    /**
     * Set the value of [codice] column.
     *
    ...
    public function setCodice($v)
    {
        ...
        if ($this->codice !== $v) {
            $this->codice = $v;
            $this->modifiedColumns[AbbonamentiTableMap::COL_CODICE] = true;
        }
    ...
    public function setCosto($v)
    {
        ...
        if ($this->costo !== $v) {
            $this->costo = $v;
            $this->modifiedColumns[AbbonamentiTableMap::COL_COSTO] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AbbonamentiTableMap::translateFieldName('IdAbbonamento', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_abbonamento = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AbbonamentiTableMap::translateFieldName('Codice', TableMap::TYPE_PHPNAME, $indexType)];
            $this->codice = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AbbonamentiTableMap::translateFieldName('Costo', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = AbbonamentiTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Abbonamenti'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAbbonamentiQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Abbonamenti::setDeleted()
     * @see Abbonamenti::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAbbonamentiQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AbbonamentiTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AbbonamentiTableMap::COL_ID_ABBONAMENTO)) {
            $modifiedColumns[':p' . $index++]  = 'id_abbonamento';
        }
        if ($this->isColumnModified(AbbonamentiTableMap::COL_CODICE)) {
            $modifiedColumns[':p' . $index++]  = 'codice';
        }
        if ($this->isColumnModified(AbbonamentiTableMap::COL_COSTO)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id_abbonamento':
                        ...
                        break;
                    case 'codice':
                        $stmt->bindValue($identifier, $this->codice, PDO::PARAM_STR);
                        break;
                    case 'costo':
    ...
    {
        $pos = AbbonamentiTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Abbonamenti'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Abbonamenti'][$this->hashCode()] = true;
        $keys = AbbonamentiTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdAbbonamento(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setIdAbbonamento($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setCodice($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setCosto($arr[$keys[2]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AbbonamentiTableMap::COL_ID_ABBONAMENTO)) {
            $criteria->add(AbbonamentiTableMap::COL_ID_ABBONAMENTO, $this->id_abbonamento);
        }
        if ($this->isColumnModified(AbbonamentiTableMap::COL_CODICE)) {
            $criteria->add(AbbonamentiTableMap::COL_CODICE, $this->codice);
        }
        if ($this->isColumnModified(AbbonamentiTableMap::COL_COSTO)) {
            $criteria->add(AbbonamentiTableMap::COL_COSTO, $this->costo);
        }
    ...
    {
        $criteria = ChildAbbonamentiQuery::create();
        $criteria->add(AbbonamentiTableMap::COL_ID_ABBONAMENTO, $this->id_abbonamento);
    ...
    {
        $validPk = null !== $this->getIdAbbonamento();
    ...
    /**
     * Generic method to set the primary key (id_abbonamento column).
     *
    ...
    {
        return null === $this->getIdAbbonamento();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Abbonamenti (or compatible) type.
    ...
    {
        $copyObj->setCodice($this->getCodice());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdAbbonamento(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Abbonamenti Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildAbbonamenti is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildAbbonamenti The current object (for fluent API support)
     */
    public function setAssegnamentiPostaziones(Collection $assegnamentiPostaziones, ConnectionInterface $con = null)
    {
        ...
        foreach ($assegnamentiPostazionesToDelete as $assegnamentiPostazioneRemoved) {
            $assegnamentiPostazioneRemoved->setAbbonamenti(null);
        }
    ...
    protected function doAddAssegnamentiPostazione(ChildAssegnamentiPostazione $assegnamentiPostazione)
    {
        ...
        $assegnamentiPostazione->setAbbonamenti($this);
    }
    ...
    public function removeAssegnamentiPostazione(ChildAssegnamentiPostazione $assegnamentiPostazione)
    {
        if ($this->getAssegnamentiPostaziones()->contains($assegnamentiPostazione)) {
            ...
            $assegnamentiPostazione->setAbbonamenti(null);
        }
     ...
     * Otherwise if this Abbonamenti is new, it will return
     * an empty collection; or if this Abbonamenti has previously
     * been saved, it will retrieve related AssegnamentiPostaziones from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Abbonamenti.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(AbbonamentiTableMap::DEFAULT_STRING_FORMAT);
    }
